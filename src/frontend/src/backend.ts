...
export class Backend implements backendInterface {
    ...
    async addSession(arg0: string, arg1: Time, arg2: Time): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addSession(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async calculateCompletionRate(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.calculateCompletionRate();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async completeSession(arg0: string): Promise<void> {
        if (this.processError) {
            try {
